...
This was how the analysis was done in the actual paper, but again the `sig_score_trt_cp_n204975x10174.gctx` file was not included due to size and potential license issues (see [previous chunk]({#pre-process})). 
```{r}
...
drgbnk_db <- 
  readRDS('data/pert_overlap_cmap_drugbank_stitch.rds') # File mapping the perturbations to DrugBank and STITCH ids. 
