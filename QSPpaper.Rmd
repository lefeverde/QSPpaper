...
# TODO list
Create example data frames of data not included due to licensing -> Done
Consolidate my packages and add in any documentation -> In progress
Create README -> Not started
Automate code testing -> Might be too time consuming
...
biosnap <- read_rds("data-raw/PPT-Ohmnet_edgelist_liver.rds")
# write_csv(biosnap, "biosnap_liver_ppi_network.txt")
...
kegg_data <- read_rds("data-raw/kegg_pathway_entrezgene.rds") %>% 
  setNames(., c("id", "entrezgene"))
kegg_data <- left_join(kegg_data, read_rds("data-raw/kegg_pathway_hierarchy.rds"))
...
Again the python code can be found [here](https://github.com/emreg00/toolbox). I excuted in this in the top-level dir of this repo. 
...
#TODO fix missing ha section 07/08/21
tmp_ht <-
  Heatmap(tmp_data, 
          # Column args
